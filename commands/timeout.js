...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Yellow")
            .setTitle("<:white_check_mark: 1039607067729727519> | Bir Üye Susturuldu!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:white_check_mark: 1039607067729727519> | ${kullanıcı} adlı kullanıcıya **${süre}** süre boyunca timeout atıldı!`)
