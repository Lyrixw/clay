...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const basarili = new Discord.EmbedBuilder()
            .setColor("Green")
            .setTitle("<:white_check_mark: 1039607067729727519> | Başarıyla Ayarlandı!")
            .setDescription("<:white_check_mark: 1039607067729727519> | Botlist sistemi başarıyla ayarlandı!")
            .setFooter({ text: "Silex" })
