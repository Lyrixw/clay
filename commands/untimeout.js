...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Green")
            .setTitle("<:white_check_mark: 1039607067729727519> | Bir Üye'nin Susturması Kaldırıldı!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:white_check_mark: 1039607067729727519> | ${kullanıcı} adlı üyenin susturmasını kaldırdım.`)
